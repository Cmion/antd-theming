...
export const evalStatusColor = (status) => {
  switch (status) {
    case "baking":
      return "geekblue";
    case "coding":
  ...
  columns: [
    {
      ...
      actionCallback: (source) => console.log("action clicked id", source),
    ...
    },
    {
      ...
      presentationColor: (value) => evalStatusColor(value),
      multiple: true,
      listMenu: [
    ...
    // //
    {
      ...
      actionCallback: (source) => console.log("action clicked id2", source),
    ...
    <div>
      ...
      >
        ...
        <ReactTable.Body
          ...
          onCellSelect={(selectCount) => ({
            onDelete: (source) => console.log(source, selectCount),
            onPin: (source) => console.log(source, selectCount),
          })}
          expandedView={(source) => {
            return (
              <div>
            ...
            >
              {({ source }) => {
                return (
                  ...
                  >
                    <Menu.Divider />
                    {selectMenu.map(({ onClick, icon, title }, index) => (
                      <Menu.Item
